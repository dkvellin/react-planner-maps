...
export default function Viewer2D({state, width, height},
  ...
  return (
    <div className="draw-board-cont" style={{width:`calc(100% - 350px)`}}>
      <GoogleMapReact 
          bootstrapURLKeys={{ key: 'AIzaSyAIdFegRbfOurYRvDN8oQNJRmpKgIj48ZY' }}
          center={{lat: 12.981102, lng: 80.164212 }}
          defaultZoom={17}
          options={{scrollwheel: true,mapTypeControl: false,scaleControl:false }}
          >
   
    
        <div className="draw-board-cont1" lat={12.981100} lng={80.164212 } style={{width:width,position:`absolute`,left:`-${width/2}px`,top:`-${height/2}px`}}>
            <ReactSVGPanZoom 
              ...
              <svg width={scene.width} height={scene.height}>
                <g style={Object.assign(mode2Cursor(mode), mode2PointerEvents(mode)),{transform:`matrix(1, 0, 0, 1, 0, 0)`}}>
